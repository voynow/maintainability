    ...
    return (
        <>
            ...
            <main className="text-gray-700">
                <section className="responsive-section w-full flex justify-center px-4 pt-8 relative pb-32 mt-32">
                ...
                <section className="responsive-section w-full flex justify-center px-4 pt-8 relative">
                    <div className="relative shadow-2xl rounded-lg">
                        <img src="/landing_page.png" alt="Workflow" className="max-w-5xl w-full h-auto" />
                    </div>
                </section>
                <section className="responsive-section flex justify-center p-4 mb-24 mt-32">
